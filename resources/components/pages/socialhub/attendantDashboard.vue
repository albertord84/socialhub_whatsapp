                ...
                <b-card class="article_widget">
                    <div class="row">
                        <div class="col-12 col-lg-9 col-sm-9 text_color mt-2">
                            ...
                            <p class="mt-4 ml-3">Morbi nisi elit, blandit sit amet tincidunt eget, ullamcorper at diam.
                                Nunc ultricies semper
                ...
                <div class="row">
                    <div class="col-xl-6 col-lg-6 col-sm-6">
                        <b-card>
                            ...
                            <vue-chartist :data="donut.data" :options="donut.options" type="Pie"
                                          :responsiveOptions="donut.responsiveoptions" ref="chartist6"></vue-chartist>
                            <div class="row">
                                ...
                                <div class="col-lg-9 col-sm-12 progress_color3">
                                    <b-progress v-model="progress2counter5" variant="success" show-progress
                                                class="mb-4"></b-progress>
                    ...
                    <div class="col-xl-12 index2_table">
                        <b-card no-block>
                            ...
                            <!--<div class="table-responsive">-->
                                <!--<datatable :exportable="true" per-page="5" :rows="tableData"-->
                                           <!--:columns="columndata"></datatable>-->
                            <!--</div>-->
                            <div class="table-responsive">
                                <datatable  :rows="tableData" :columns="columndata">
                                </datatable>
                            </div>
                        </b-card>
                    </div>
