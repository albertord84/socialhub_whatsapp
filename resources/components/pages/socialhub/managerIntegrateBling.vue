<template>
    <div class="card p-3">
        <form-wizard    color="#20a0ff" 
            ...
            <tab-content title="Gerar a API key">
                <hr>
                    <div class="row">
                        <p class="text-justify">
                            1) Faça login em <a href="https://www.bling.com.br" target="_blank"> https://www.bling.com.br</a>.
                            <br><br><br>
                            2) Selecione o tipo usuário como "usuário API" em <a href="https://www.bling.com.br/usuarios.php#add" target="_blank" rel="noopener noreferrer">https://www.bling.com.br/usuarios.php#add</a>
                            <br><br><br>
                            3) Preencha os campo de nome e email do "usuário API"
                            <br><br><br>
                            4)
                            Gere e copie a API key aqui
                            <br>
                            <input type="text" class="" placeholder="Adicione sua API key aqui ">
                        </p>
                    </div>
                <hr>
            </tab-content>
